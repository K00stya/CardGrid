...
Проблема того что мы вообще тратим время на эти вопросы и по ситуации перемещаем код и класса в класс исходит из того что мы воспринимаем одно общее состояние как несколько отдельных.
...
То же касается и состояния, поскольку в реальности оно может измениться из десятка мест попытка это скрыть только усложнит общее понимание кода.
